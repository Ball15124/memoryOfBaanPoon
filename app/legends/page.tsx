          ...
          {legendsData.map((item) => (
            ...
            >
              <div className="flex flex-row w-full h-full overflow-hidden items-center">
                <p
                  className="w-1/2 lg:w-1/4 m-5 text-nowrap z-10 text-lg lg:text-2xl"
        ...
        {/* <div className="relative w-full lg:w-2/3 justify-items-center lg:justify-items-start mt-10 lg:mt-0 min-h-screen">
          <div className="sticky top-[80px] container flex flex-col lg:flex-row space-x-1 lg:space-x-4">
            <div className="flex flex-col space-y-4 w-full lg:w-2/3">
              <p
                className="text-[#c53232] text-[36px] lg:text-[60px] font-bold animate-fade-in leading-tight"
                style={{ fontFamily: "MN KAEWKANLAYA, sans-serif" }}
              >
                {person?.name || (
                  <>
              ...
              {person?.id === 3 ? (
                <p className="text-white animate-fade-in">
                  ...
                  ซึ่งถูกดูแลและปกครองโดยพระโอรสองค์โตของพระเจ้าศิริบุญสาร
                  ได้แก่ พระเจ้านันทเสน พระราชธิดาองค์โตคือเจ้านางเขียวค้อม
                  ...
                  <p className="text-white animate-fade-in">
                    ...
                    ส่วนเจ้าอนุวงศ์ทรงได้รับแต่งตั้งเป็นอุปราช
                    แต่หลังจากนั้นในปี พ.ศ. 2347 พระเจ้าอินทวงศ์ก็ถึงแก่ทิวงคต
                  ...
                  <p className="text-white animate-fade-in text-center">
                    ...
                    เกตพิกุลเลียบอุโลกโศกสาขา<br /> ทุกพุ่มพักหักพังเปนรังกา
                    เมื่อเจ้าตาย่านกระหม่อมอยู่พร้อมพรัก&quot;<br />
                    &quot;บ้านที่สร้างบางยี่ขันท่านมาพัก ตึกตำหนักหักตกถึงอกไก่<br />
