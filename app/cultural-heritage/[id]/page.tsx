...
const data = [
  {
    ...
    description3:
      "ภายในอุโบสถประดิษฐาน “หลวงพ่อดำ” เป็นพระพุทธรูปประธานปางมารวิชัย ถูกสันนิษฐานว่าเป็นพระพุทธรูปเก่าแก่ช่วงสมัยอยุธยาที่เคยปิดทองแต่หลุดลอกออกไปจนเหลือแต่เพียงสีดำ โดยข้างๆ มีพระสาวก 2 องค์ยืนถวายอัญชลี ผนังภายในสองข้างเจาะช่องเว้ารูปวงโค้ง ยอดแหลมเรียงกัน ด้านหลังพระประธานไม่มีประตูแต่เจาะหน้าต่างเล็กๆ 2 ช่อง บนเพดานเขียนลายทองบนพื้นแดง ยังคงอยู่ในสภาพดี ส่วนโดยรอบด้านนอกมีร่องรอยการบูรณะในภายหลัง",
    description4:
  ...
  },
  {
    ...
    description3:
      "จากคำบอกเล่าของผู้อาวุโสในชุมชนเล่าว่าในอดีตจะมีเรือมารอรับขนมจีนในบริเวณนี้กันอย่างครึกครื้นและแน่นหนา ส่วนใหญ่พ่อค้าแม่ค้าจะนำเรือมาเทียบที่ท่าเพื่อมารับขนมจีนและนำไปขายยังตลาดต่างๆ ในบริเวณโดยรอบ เช่น ตลาดเทเวศร์ ตลาดบางลำพู ตลาดสามเสน เป็นต้น ปัจจุบันโรงขนมจีนในชุมชนบ้านปูนแห่งนี้ได้ปิดตัวลงไปเป็นเวลานานแล้วตามความนิยมที่น้อยลงและสังคมที่เปลี่ยนไป ตอนนี้พื้นที่ที่เคยเป็นจุดตั้งก็ได้ถูกทางการทุบทิ้งไปแล้ว เพื่ิอนำไปต่อเติมเป็นท่าเรือบริเวณริมแม่น้ำเจ้าพระยาอย่างที่ได้เห็นในปัจจุบัน",
              ...
              <p className="text-white text-start mx-5 lg:mx-14">
                ...
                <ul className="list-disc pl-6 sm:pl-10 space-y-3 lg:space-y-5">
                  ...
                  <li>
                    ...
                    ใช้น้ำเย็นราดให้หินปูนแตกย่อยเป็นชิ้นเล็กๆ
